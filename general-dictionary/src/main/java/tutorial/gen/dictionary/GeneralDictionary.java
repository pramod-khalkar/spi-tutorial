package tutorial.gen.dictionary;
...
public class GeneralDictionary implements Dictionary {
    ...
    static {
        dictionaryMap.put("good", "[GeneralDictionary] to be desired or approved of");
        dictionaryMap.put("book",
                "[GeneralDictionary] a written or printed work consisting of pages glued or sewn together along one side and bound in covers.");
    }
